...
if (R.Version()$arch == "x86_64") {
  ...
  pak::repo_add(CRAN = "https://p3m.dev/cran/__linux__/noble/2025-06-03")
  pak::repo_add(BioCsoft = "https://packagemanager.posit.co/bioconductor/__linux__/noble/2025-06-03")
}

# Setup package URLs for ARM/AARCH64
if (R.Version()$arch == "aarch64") {
  pak::repo_add(universe = "https://mrcieu.r-universe.dev/bin/linux/noble-aarch64/4.5/")
  pak::repo_add(CRAN = "https://p3m.dev/cran/2025-06-03")
  pak::repo_add(BioCsoft = "https://packagemanager.posit.co/bioconductor/2025-06-03")
}
...
options(
  BIOCONDUCTOR_CONFIG_FILE = "https://packagemanager.posit.co/bioconductor/2025-06-03/config.yaml"
)
