...
check:
    docker pull --platform linux/amd64 rocker/r-ver:4.5.3
    docker run --platform linux/amd64 rocker/r-ver:4.5.3 cat /etc/lsb-release
    docker pull --platform linux/arm64 rocker/r-ver:4.5.3
    docker run --platform linux/arm64 rocker/r-ver:4.5.3 cat /etc/lsb-release
